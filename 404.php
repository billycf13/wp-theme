    ...
    <div class="container">
        <main id="primary" class="site-main error-404 not-found">
            ...
            <div class="page-content">
                <p>Sepertinya tautan yang Anda tuju sudah rusak atau halamannya telah dipindahkan. Silakan kembali ke Beranda atau telusuri produk yang Anda butuhkan di bawah ini.</p>
                ...
                <div class="search-404">
                    <form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                        ...
                        <input type="search" class="search-field" placeholder="Ketik jenis alat test / produk..." value="<?php echo get_search_query(); ?>" name="s" />
