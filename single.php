                ...
                <?php else : ?>
                    ...
                    <div class="widget">
                        ...
                        <form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>" style="display:flex;">
                            <input type="search" class="search-field" placeholder="Cari..." value="<?php echo get_search_query(); ?>" name="s" style="flex:1; padding:10px; border:1px solid #ddd; border-radius:4px 0 0 4px; outline:none;" />
