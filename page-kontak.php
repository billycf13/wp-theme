...
<div class="contact-page">
    <div class="container">
        ...
        <div class="contact-container">
            ...
            <div class="contact-form-panel">
                ...
                <form action="#" method="POST" id="contactForm">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <input type="tel" name="phone" class="form-control" placeholder="Nomor Telepon / WhatsApp" required>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        <textarea name="message" class="form-control" placeholder="Tulis pesan, pertanyaan, atau keluhan Anda secara detail di sini..." required></textarea>
                    </div>
                    <button type="submit" class="btn-submit">Kirim Pesan Sekarang</button>
                    <p style="margin-top: 15px; font-size: 13px; color: #999;">* Kami akan merespon pesan Anda secepatnya pada jam kerja via Email atau Telepon.</p>
                </form>
            </div>
        </div>
        ...
        <div class="contact-map">
            <iframe src="https://maps.google.com/maps?q=CV.%20Java%20Multi%20Mandiri,%20Sumbang&t=&z=13&ie=UTF8&iwloc=&output=embed" allowfullscreen="" loading="lazy" title="Google Maps Alat-Test"></iframe>
        </div>
    </div>
</div>
